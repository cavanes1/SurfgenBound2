...
TYPE abpoint
  ...
  DOUBLE PRECISION,dimension(:,:,:),allocatable :: igrads
  INTEGER                                       :: lb,ub

  INTEGER                                       :: nvibs
  DOUBLE PRECISION,dimension(:,:),allocatable   :: bmat,cbmat
  DOUBLE PRECISION,dimension(:,:),allocatable   :: lmat
  DOUBLE PRECISION,dimension(:,:),allocatable   :: binv
  DOUBLE PRECISION,dimension(:),allocatable     :: scale

  !ab initio determined quasi-degeneracy group
  INTEGER,dimension(:,:),allocatable            :: deg_groups
  INTEGER                                       :: ndeggrp
  !model determined quasi-degeneracy group
  INTEGER,dimension(:,:),allocatable            :: deg_groupsHd
  INTEGER                                       :: ndeggrpHd
end TYPE abpoint
